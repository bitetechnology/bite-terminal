...
const Navbar: React.FC = () => {
            ...
            <header className="flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full rounded-md bg-black text-sm py-4">
                <nav className="max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between" aria-label="Global">
                    <div className="flex items-center justify-between">
                        <a className="flex-none text-xl font-semibold text-white" href="#">BiTE</a>
                    ...
                    <div id="navbar-primary" className="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow sm:block">
                        <div className="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:pl-5">
                            <a className="font-medium text-gray-300 hover:text-white" href="#">Very Açai</a>
                        </div>
                    </div>
                </nav>
            </header>
    ...
    <span className="text-black font-bold text-3xl" style={{ fontFamily: '"Plus Jakarta Sans", sans-serif' }}>
        Bite Terminal
    </span>
</div>
        </div>
